...
.method public static getErrorDialog(ILandroid/app/Activity;I)Landroid/app/Dialog;
    ...
    .line 1000
    invoke-static {p0, p1, v1, v0, v1}, Lcom/google/android/gms/common/GooglePlayServicesUtil;->zza(ILandroid/app/Activity;Landroid/support/v4/app/Fragment;ILandroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
...
.method public static isPackageGoogleSigned(Landroid/content/pm/PackageManager;Ljava/lang/String;)Z
    ...
    invoke-virtual {v0, p0, p1}, Lcom/google/android/gms/common/GoogleSignatureVerifier;->isPackageGoogleSigned(Landroid/content/pm/PackageManager;Ljava/lang/String;)Z
...
.method public static showErrorDialogFragment(ILandroid/app/Activity;I)Z
    ...
    .line 3000
    invoke-static {p0, p1, v1, v0, v1}, Lcom/google/android/gms/common/GooglePlayServicesUtil;->showErrorDialogFragment(ILandroid/app/Activity;Landroid/support/v4/app/Fragment;ILandroid/content/DialogInterface$OnCancelListener;)Z
...
.method private static zza(ILandroid/app/Activity;Landroid/support/v4/app/Fragment;ILandroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
    ...
    :cond_0
    invoke-static {p1}, Landroid/support/v4/content/res/ConfigurationHelper$ConfigurationHelperImpl;->zzax(Landroid/content/Context;)Z
    ...
    :cond_2
    invoke-static {}, Landroid/support/v4/content/res/ConfigurationHelper$ConfigurationHelperImpl;->zzsl()Z
    ...
    :cond_4
    invoke-static {p1}, Lcom/google/android/gms/common/GooglePlayServicesUtil;->zzap(Landroid/content/Context;)Ljava/lang/String;

    move-result-object v1

    invoke-static {p1, p0, v1}, Landroid/support/v4/content/res/ConfigurationHelper$ConfigurationHelperImpl;->zzb(Landroid/content/Context;ILjava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v1, p1, p0, v2}, Lcom/google/android/gms/common/GoogleApiAvailability;->getErrorResolutionIntent(Landroid/content/Context;ILjava/lang/String;)Landroid/content/Intent;
    ...
    :goto_1
    invoke-static {p1, p0}, Landroid/support/v4/content/res/ConfigurationHelper$ConfigurationHelperImpl;->zzg(Landroid/content/Context;I)Ljava/lang/String;
    ...
    :cond_6
    invoke-static {p1, p0}, Landroid/support/v4/content/res/ConfigurationHelper$ConfigurationHelperImpl;->zzf(Landroid/content/Context;I)Ljava/lang/String;
