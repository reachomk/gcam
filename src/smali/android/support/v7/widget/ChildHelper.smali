.class final Landroid/support/v7/widget/ChildHelper;
...
.method private final getOffset(I)I
    .locals 4
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/ChildHelper$Callback;->getChildCount()I
...
.method private final hideViewInternal(Landroid/view/View;)V
    .locals 1
    ...
    invoke-virtual {v0, p1}, Landroid/support/v7/widget/ChildHelper$Callback;->onEnteredHiddenState(Landroid/view/View;)V

    .line 62
    return-void
.end method

.method private final unhideViewInternal(Landroid/view/View;)Z
    .locals 1
    ...
    invoke-virtual {v0, p1}, Landroid/support/v7/widget/ChildHelper$Callback;->onLeftHiddenState(Landroid/view/View;)V
...
# virtual methods
.method final addView(Landroid/view/View;IZ)V
    .locals 2
    ...
    invoke-virtual {v1, p1, v0}, Landroid/support/v7/widget/ChildHelper$Callback;->addView(Landroid/view/View;I)V
...
.method final addView(Landroid/view/View;Z)V
    .locals 2
    ...
    invoke-virtual {p0, p1, v0, v1}, Landroid/support/v7/widget/ChildHelper;->addView(Landroid/view/View;IZ)V

    .line 86
    return-void
.end method

.method final attachViewToParent(Landroid/view/View;ILandroid/view/ViewGroup$LayoutParams;Z)V
    .locals 2
    ...
    invoke-virtual {v1, p1, v0, p3}, Landroid/support/v7/widget/ChildHelper$Callback;->attachViewToParent(Landroid/view/View;ILandroid/view/ViewGroup$LayoutParams;)V
...
.method final detachViewFromParent(I)V
    ...
    invoke-virtual {v1, v0}, Landroid/support/v7/widget/ChildHelper$Callback;->detachViewFromParent(I)V
...
.method final getChildAt(I)Landroid/view/View;
    ...
    invoke-virtual {v1, v0}, Landroid/support/v7/widget/ChildHelper$Callback;->getChildAt(I)Landroid/view/View;
...
.method final getUnfilteredChildAt(I)Landroid/view/View;
    .locals 1
    ...
    invoke-virtual {v0, p1}, Landroid/support/v7/widget/ChildHelper$Callback;->getChildAt(I)Landroid/view/View;
...
.method final getUnfilteredChildCount()I
    .locals 1
...
.method final hide(Landroid/view/View;)V
    .locals 3
    ...
    invoke-virtual {v0, p1}, Landroid/support/v7/widget/ChildHelper$Callback;->indexOfChild(Landroid/view/View;)I
...
.method final indexOfChild(Landroid/view/View;)I
    ...
    invoke-virtual {v1, p1}, Landroid/support/v7/widget/ChildHelper$Callback;->indexOfChild(Landroid/view/View;)I
...
.method final isHidden(Landroid/view/View;)Z
    .locals 1
...
.method final removeView(Landroid/view/View;)V
    .locals 2
    ...
    invoke-virtual {v1, v0}, Landroid/support/v7/widget/ChildHelper$Callback;->removeViewAt(I)V
...
.method final removeViewIfHidden(Landroid/view/View;)Z
    .locals 3
    ...
    invoke-virtual {v2, v1}, Landroid/support/v7/widget/ChildHelper$Callback;->removeViewAt(I)V
...
.method final unhide(Landroid/view/View;)V
    .locals 3
