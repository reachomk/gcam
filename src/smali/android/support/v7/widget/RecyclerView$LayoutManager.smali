...
.method private final addViewInt(Landroid/view/View;IZ)V
    .locals 8
    ...
    invoke-virtual {v1, p1, p2, v3, v7}, Landroid/support/v7/widget/ChildHelper;->attachViewToParent(Landroid/view/View;ILandroid/view/ViewGroup$LayoutParams;Z)V

    .line 7384
    :cond_2
    :goto_2
    iget-boolean v1, v0, Landroid/support/v7/widget/RecyclerView$LayoutParams;->mPendingInvalidate:Z
    ...
    .line 7389
    iput-boolean v7, v0, Landroid/support/v7/widget/RecyclerView$LayoutParams;->mPendingInvalidate:Z
    ...
    .line 12637
    :cond_9
    invoke-direct {v3, v1}, Landroid/support/v7/widget/RecyclerView$LayoutManager;->detachViewAt(I)V
    ...
    .line 14582
    iget-object v6, v3, Landroid/support/v7/widget/RecyclerView$LayoutManager;->mRecyclerView:Landroid/support/v7/widget/RecyclerView;

    iget-object v6, v6, Landroid/support/v7/widget/RecyclerView;->mViewInfoStore:Landroid/support/v7/widget/ViewInfoStore;

    invoke-virtual {v6, v5}, Landroid/support/v7/widget/ViewInfoStore;->addToDisappearedInLayout(Landroid/support/v7/widget/RecyclerView$ViewHolder;)V
    ...
    invoke-virtual {v3, v4, p2, v1, v5}, Landroid/support/v7/widget/ChildHelper;->attachViewToParent(Landroid/view/View;ILandroid/view/ViewGroup$LayoutParams;Z)V
    ...
    invoke-virtual {v6, v5}, Landroid/support/v7/widget/ViewInfoStore;->removeFromDisappearedInLayout(Landroid/support/v7/widget/RecyclerView$ViewHolder;)V
    ...
    invoke-virtual {v1, p1, p2, v7}, Landroid/support/v7/widget/ChildHelper;->addView(Landroid/view/View;IZ)V
...
# virtual methods
.method public final addDisappearingView(Landroid/view/View;I)V
    .locals 1
...
.method public final detachAndScrapAttachedViews(Landroid/support/v7/widget/RecyclerView$Recycler;)V
    ...
    .line 17279
    invoke-virtual {v1, v2}, Landroid/support/v7/widget/ViewInfoStore;->removeFromDisappearedInLayout(Landroid/support/v7/widget/RecyclerView$ViewHolder;)V
...
.method public onItemsAdded$51662RJ4E9NMIP1FEDQN0S3FE9Q2UTHN5TRMIP37CLQ2UKJ5CDSM6R35E9B6IPBN7D4KIAAM()V
    .locals 0
...
.method public onItemsChanged$51662RJ4E9NMIP1FEDQN0S3FE9Q2UTHN5TRMIP37CLQ2UKJ5CDSM6R35E9B6IPBN7CKLC___()V
    .locals 0
...
.method public onItemsMoved$51662RJ4E9NMIP1FEDQN0S3FE9Q2UTHN5TRMIP37CLQ2UKJ5CDSM6R35E9B6IPBN7D4KII99AO______()V
    .locals 0
...
.method public onItemsRemoved$51662RJ4E9NMIP1FEDQN0S3FE9Q2UTHN5TRMIP37CLQ2UKJ5CDSM6R35E9B6IPBN7D4KIAAM()V
    .locals 0
...
.method public onItemsUpdated$51662RJ4E9NMIP1FEDQN0S3FE9Q2UTHN5TRMIP37CLQ2UKJ5CDSM6R35E9B6IPBN7D4KIJ3AC5R62BRCC5N6EBQFC9L6AORK7CKLC___(Landroid/support/v7/widget/RecyclerView;II)V
    .locals 0
...
.method public final onMeasure$51662RJ4E9NMIP1FEDQN0S3FE9Q2UTHN5TRMIP37CLQ2UKJ5CDSM6R35E9B6IPBN4H96AORPCDM6ASHR9HGMSP3IDTKM8BRJELO70RRIEGNNCDPFETKM8PR5EGNL4PB3F5HMOPBIAPKMATP4ADQ62T357D4KIAAM(II)V
    .locals 1
...
.method final performAccessibilityAction(ILandroid/os/Bundle;)Z
    .locals 6
...
.method final removeAndRecycleScrapInt(Landroid/support/v7/widget/RecyclerView$Recycler;)V
    ...
    .line 7981
    .line 17556
    iget-object v0, p1, Landroid/support/v7/widget/RecyclerView$Recycler;->mAttachedScrap:Ljava/util/ArrayList;
    ...
    .line 8002
    invoke-virtual {p1, v0}, Landroid/support/v7/widget/RecyclerView$Recycler;->quickRecycleScrapView(Landroid/view/View;)V
    ...
    .line 17565
    iget-object v0, p1, Landroid/support/v7/widget/RecyclerView$Recycler;->mChangedScrap:Ljava/util/ArrayList;
...
.method final shouldReMeasureChild(Landroid/view/View;IILandroid/support/v7/widget/RecyclerView$LayoutParams;)Z
    .locals 2
