...
.method private final checkNewEdgeDrag(FFII)Z
    .locals 4
...
.method private final checkTouchSlop(Landroid/view/View;FF)Z
    .locals 5
    ...
    invoke-virtual {v3}, Landroid/support/v4/widget/ViewDragHelper$Callback;->getViewVerticalDragRange$51662RJ4E9NMIP1FEPKMATPFAPKMATPR554G____()I
...
.method private final clearMotionHistory(I)V
    .locals 3
    ...
    invoke-direct {p0, p1}, Landroid/support/v4/widget/ViewDragHelper;->isPointerDown(I)Z
...
.method private final computeAxisDuration(III)I
    .locals 9
...
.method private final dispatchViewReleased(FF)V
    .locals 4
...
.method private final forceSettleCapturedViewAt(IIII)Z
    .locals 14
    ...
    invoke-virtual {v8}, Landroid/support/v4/widget/ViewDragHelper$Callback;->getViewVerticalDragRange$51662RJ4E9NMIP1FEPKMATPFAPKMATPR554G____()I
...
.method private final isValidPointerForActionMove(I)Z
    .locals 3
...
.method private final releaseViewForPointerUp()V
    .locals 4
...
.method private final reportNewEdgeDrags(FFI)V
    .locals 3
...
.method private final saveInitialMotion(FFI)V
    .locals 11
...
.method private final saveLastMotion(Landroid/view/MotionEvent;)V
    .locals 6
...
.method public final checkTouchSlop(I)Z
    ...
    .line 8352
    invoke-direct {p0, v3}, Landroid/support/v4/widget/ViewDragHelper;->isPointerDown(I)Z
...
.method public final continueSettling(Z)Z
    ...
    .line 4079
    iget-object v3, v3, Landroid/support/v4/widget/ScrollerCompat;->mScroller:Landroid/widget/OverScroller;
    ...
    invoke-static {v6, v5}, Landroid/support/v4/view/ViewCompat;->offsetTopAndBottom(Landroid/view/View;I)V
    ...
    invoke-virtual {v4, v5, v2, v3}, Landroid/support/v4/widget/ViewDragHelper$Callback;->onViewPositionChanged$51662RJ4E9NMIP1FEPKMATPFAPKMATPR954KII99AO______(Landroid/view/View;II)V
...
.method public final processTouchEvent(Landroid/view/MotionEvent;)V
    ...
    invoke-virtual {v0}, Landroid/support/v4/widget/ViewDragHelper$Callback;->onEdgeTouched$514KIAAM()V
    ...
    .line 1130
    invoke-direct {p0, v3, v4, v1}, Landroid/support/v4/widget/ViewDragHelper;->saveInitialMotion(FFI)V
    ...
    invoke-virtual {p0, v0, v2}, Landroid/support/v4/widget/ViewDragHelper;->findTopChildUnder(II)Landroid/view/View;

    move-result-object v0

    .line 1137
    invoke-direct {p0, v0, v1}, Landroid/support/v4/widget/ViewDragHelper;->tryCaptureViewForDrag(Landroid/view/View;I)Z
    ...
    invoke-virtual {v6, v7, v1}, Landroid/support/v4/widget/ViewDragHelper$Callback;->clampViewPositionHorizontal$51662RJ4E9NMIP1FEPKMATPFAPKMATPR954III8_(Landroid/view/View;I)I
    ...
    invoke-virtual {v4, v6, v0}, Landroid/support/v4/widget/ViewDragHelper$Callback;->clampViewPositionVertical$51662RJ4E9NMIP1FEPKMATPFAPKMATPR954III8_(Landroid/view/View;I)I
    ...
    invoke-virtual {v2, v3, v1, v0}, Landroid/support/v4/widget/ViewDragHelper$Callback;->onViewPositionChanged$51662RJ4E9NMIP1FEPKMATPFAPKMATPR954KII99AO______(Landroid/view/View;II)V
    ...
    .line 1181
    invoke-direct {p0, v6, v7, v3}, Landroid/support/v4/widget/ViewDragHelper;->reportNewEdgeDrags(FFI)V
    ...
    .line 1189
    invoke-direct {p0, v4, v3}, Landroid/support/v4/widget/ViewDragHelper;->tryCaptureViewForDrag(Landroid/view/View;I)Z
    ...
    .line 1239
    invoke-direct {p0, v6, v6}, Landroid/support/v4/widget/ViewDragHelper;->dispatchViewReleased(FF)V
...
.method public final shouldInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    .line 979
    invoke-direct {p0, v0, v2}, Landroid/support/v4/widget/ViewDragHelper;->tryCaptureViewForDrag(Landroid/view/View;I)Z
    ...
    invoke-virtual {v9, v4, v8}, Landroid/support/v4/widget/ViewDragHelper$Callback;->clampViewPositionHorizontal$51662RJ4E9NMIP1FEPKMATPFAPKMATPR954III8_(Landroid/view/View;I)I
    ...
    invoke-virtual {v11, v4, v10}, Landroid/support/v4/widget/ViewDragHelper$Callback;->clampViewPositionVertical$51662RJ4E9NMIP1FEPKMATPFAPKMATPR954III8_(Landroid/view/View;I)I
    ...
    invoke-virtual {v12}, Landroid/support/v4/widget/ViewDragHelper$Callback;->getViewVerticalDragRange$51662RJ4E9NMIP1FEPKMATPFAPKMATPR554G____()I
